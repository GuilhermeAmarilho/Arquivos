...
# from usuario import Usuario
# u = Usuario(nome="GuilhermeAmarilho",login="amarilho", senha='wukong',cod=2)
# i = Ideia(usuario=u,cod=7,titulo="titulo 7", descricao='descricao 7')
# a = IdeiaDao()
# print(a.buscar(6).usuario.nome)